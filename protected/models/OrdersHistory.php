...
class OrdersHistory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			//array('report_id, created_by, modified_by', 'numerical', 'integerOnly'=>true),
			array('modify_time, report_id, create_time, created_by, modified_by, next_contact_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, report_id, create_time, modify_time, created_by, modified_by, description', 'safe', 'on'=>'search'),
		);
	}
