 ...
 */
class ProjectManagerReport extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, time, company, phone_number, company_address, email, contact_person, business_type, service_type, next_call, contact_type, comment, caller_id, call_status, manager_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ProjectManagerReport the static model class
	 */
