	...
	<div id="mainmenu">
		...
		$this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Мои отчеты', 'url'=>array('/callerReport/myreport'), 'visible'=>Yii::app()->user->role==1),
				...
				array('label'=>'Перезвоны', 'url'=>array('/callLater/admin'), 'visible'=>Yii::app()->user->role==1),
